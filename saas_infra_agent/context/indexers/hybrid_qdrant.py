...
from saas_infra_agent.context.indexers.code_parser import parse_file, get_source_files
...
def index_codebase(repo_path: str) -> QdrantVectorStore:
    ...
    # Validate existing collection schema (dense vs sparse/hybrid) before reusing it.
